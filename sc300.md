...
- (Lockout Threshold) $_{EntraID\}$ < (Lockout Threshold) $_{WS-AD\}$

- (Lockout Duration) $_{EntraID\}$ > (Lockout Duration) $_{WS-AD\}$
...
- more information : https://learn.microsoft.com/en-us/entra/identity/app-proxy/overview-what-is-app-proxy
